...
//        SingleOutputStreamOperator a = lines.flatMap(new FlatMapFunction<String, Tuple2<String, Integer>>() {
//            @Override
//            public void flatMap(String value, Collector<Tuple2<String, Integer>> out) throws Exception {
//
//                String[] arr = value.split(" ");
...
////            private MapState<String, Integer> wcCountMapState  = getRuntimeContext().getMapState(new MapStateDescriptor<String, Integer>
...
//////                // 创建StateDescriptor
////
////               // System.out.println("wcCountMapState:" + wcCountMapState);
////            }
////
////            @Override
...
////               return new Tuple2<String, Integer>(tuple.f0, value);
////            }
////        });
...
//                System.out.println("open: ");
//                // 创建StateDescriptor
//                wcCountMapState = getRuntimeContext().getMapState(new MapStateDescriptor<String, Integer>("mapstate", String.class, Integer.class));
//                System.out.println("wcCountMapState:" + wcCountMapState);
//            }
//
//            @Override
...
//}
//
//class MapStateFunction extends KeyedProcessFunction<Tuple, Tuple2<String, Integer>, Tuple2<Tuple, Integer>> {
//    private MapState<String, Integer> wcCountMapState = null;
//
//    @Override
//    public void open(Configuration parameters) throws Exception {
...
//
//    @Override
//    public void processElement(Tuple2<String, Integer> tuple, Context ctx, Collector<Tuple2<Tuple, Integer>> out) throws Exception {
//        Integer value = 0;
//        if (wcCountMapState.contains(tuple.f0)) {
//            value = wcCountMapState.get(tuple.f0) + tuple.f1;
//        } else {
//            value = tuple.f1;
//        }
//        out.collect(new Tuple2(tuple.f0, value));
//    }
//}
//
//
...
////
////            @Override
////            public void processElement(Tuple2<String, Integer> tuple, Context ctx, Collector<Integer> out) throws Exception {
////                Integer value = 0;
////                if (wcCountMapState.contains(tuple.f0)) {
////                    value = wcCountMapState.get(tuple.f0) + tuple.f1;
////                } else {
